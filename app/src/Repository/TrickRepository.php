...
//    public function findTenTricks( int $lastIndex, int $limit = 10, int $offset = 1)
//    {
//        $dql = 'SELECT * FROM App\Entity\Trick as trick WHERE trick.id = '
//    }

//    public function find10tricks()
//    {
//
//    }
}
